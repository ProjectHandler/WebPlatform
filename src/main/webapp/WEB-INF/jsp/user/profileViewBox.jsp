			...
			<div class="clearfix">
				...
				<div class="float-left">
					<div style="padding: 0 0 0 0; margin: 90px 0 0 90px;">
						...
						<div class="text-h2 theme3-primary-text">${e:forHtml(userToFind.firstName)} ${e:forHtml(userToFind.lastName)}</div>
						<div class="text-h4 theme1-primary-text">${e:forHtml(userToFind.email)}</div>
				...
				<c:forEach var="project" items="${userToFind.projects}">
					<div class="margin-left margin-bottom">
						...
						<div class="display-table-cell vertical-align">
							<div class="text-h3">${e:forHtml(project.name)}</div>
							<div class="small theme3-darken2-text">${e:forHtml(project.status)}</div>
						</div>
					</div>
				</c:forEach>
				</div>
