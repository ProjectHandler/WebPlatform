					...
					<div class="display-table full-width">
						...
						<div class="display-table-cell vertical-align full-width">
							<div class="fixedmaxwidth-384 margin-auto">
								<h1 class="margin-bottom padding-bottom util1-primary-text"><spring:message code="projecthandler.forgotPassword.title"/></h1>

								<form name='f' action="${pageContext.request.contextPath}/sendResetPassword" method="post">
									<label>
										<div class="padding-bottom position-relative">
											...
											<input type="email" name="email" class="default-btn-shape theme3-lighten1-bdr display-block full-width" placeholder="<spring:message code="projecthandler.login.typeEmail"/>" required/>
									...
									<button name="submit" type="submit" class="default-btn-shape theme1-primary-btn-style1 display-block text-center margin-top margin-bottom  full-width"><spring:message code="projecthandler.forgotPassword.send"/></button>
								</form>
